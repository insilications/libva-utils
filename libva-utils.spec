...
Version  : 2.9.1
Release  : 18
URL      : https://github.com/intel/libva-utils/archive/2.9.1/libva-utils-2.9.1.tar.gz
Source0  : https://github.com/intel/libva-utils/archive/2.9.1/libva-utils-2.9.1.tar.gz
...
%prep
%setup -q -n libva-utils-2.9.1
cd %{_builddir}/libva-utils-2.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600963049
...
cp %{_builddir}/libva-utils-2.9.1/COPYING %{buildroot}/usr/share/package-licenses/libva-utils/946e6b5d574d506ac5f84e0826d29887b3d5a2f6
cp %{_builddir}/libva-utils-2.9.1/test/gtest/LICENSE %{buildroot}/usr/share/package-licenses/libva-utils/5a2314153eadadc69258a9429104cd11804ea304
%make_install
